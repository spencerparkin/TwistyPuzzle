...
#include "SkewbUltimate.h"
#include <Surface.h>
#include <Plane.h>

wxIMPLEMENT_DYNAMIC_CLASS( SkewbUltimate, TwistyPuzzle );

SkewbUltimate::SkewbUltimate( void )
{
}

/*virtual*/ SkewbUltimate::~SkewbUltimate( void )
{
}

/*virtual*/ void SkewbUltimate::Reset( void )
{
	Clear();
